...
if __name__ == "__main__":
    ...
    data_matrix, labels = create_data_matrix(train_folder, feature_model, label_mode='Z')
    if k != 'all' or k != '*':
    ...
    test_data_matrix, true_labels = create_data_matrix(test_folder, feature_model, label_mode='Z')
    if k != 'all' or k != '*':
